...
# SECRET_KEY = "django-insecure-sj*a@az^#(%bvd5em43(6bsp(8odh$5(4%sdi5-*a@w@b9i_da"
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'techforge'),
        'USER': os.getenv('DB_USER', 'techforge_user'),
...
# Markdown Extensions
MARKDOWN_EXTENSIONS = [
    'markdown.extensions.fenced_code',  # Code blocks in triple backticks
    'markdown.extensions.codehilite',  # Syntax highlighting
    'markdown.extensions.tables',      # Tables support
    'markdown.extensions.nl2br',       # New lines to breaks
...
MARKDOWN_EXTENSION_CONFIGS = {
    'codehilite': {
        ...
        'pygments_style': 'monokai',   # Pygments style
    }
}
...
# Required for collectstatic in Docker
